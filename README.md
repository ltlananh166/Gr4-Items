...
- **Khóa/Mở Khóa Khách Hàng (Ban/Unban):** Cập nhật trạng thái hoạt động của tài khoản khách hàng tức thì trong cơ sở dữ liệu (CSV) nhằm cấm hoặc khôi phục quyền mua hàng.
- **Quản Lý Sự Kiện Flash Sale:** Thiết lập sự kiện mới, tùy chỉnh khoảng thời gian hiệu lực và bổ sung các sản phẩm tham gia với mức giá chiết khấu cùng số lượng tồn kho giới hạn.
- **Báo Cáo Doanh Thu & Voucher:** Xuất thống kê chi tiết tổng doanh số bán ra theo từng sự kiện và phân tích tần suất sử dụng của các mã giảm giá.
